...
$.getJSON("randomData.json", function(json) {
    processJSON(json)
});
...
function processJSON(json) {
    ...
    /* for (const val of Object.keys(json)) {
    ...
    /*   for(const [key, value] of Object.entries(json)){
           ...
           levels.push(key);
           levels[key].appendChild(value);
       }*/

    let levels = Object.keys(json).map(function (key) {
        return {[key]: json[key]};
    });

    for (const entities of Object.keys(json)){

        levels.push(entities)
    }



    //console.log(Object.values(json)[0]);
    console.log(Object.keys(levels[0]));
